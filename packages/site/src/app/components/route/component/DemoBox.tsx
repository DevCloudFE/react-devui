    ...
    >
      ...
      <div className="app-demo-box__toolbar">
        <DTooltip dTitle={t('Open in CodeSandbox')}>
          <DIcon className="app-icon-button" viewBox="0 0 1024 1024" role="button" dSize={18}>
        ...
        <DTooltip dTitle={t('Open in Stackblitz')}>
          <DIcon className="app-icon-button" viewBox="64 64 896 896" role="button" dSize={18}>
        ...
        <DTooltip dTitle={copyCode ? t('Copied!') : t('Copy code')} afterVisibleChange={afterCopyTrige}>
          <DIcon className="app-icon-button" viewBox="64 64 896 896" role="button" dSize={18} onClick={handleCopyClick}>
            {copyCode ? (
        ...
        <DTooltip dTitle={openCode ? t('Hide code') : t('Show code')}>
          <DIcon className="app-icon-button" viewBox="0 0 1024 1024" role="button" dSize={18} onClick={handleOpenClick}>
            {openCode ? (
