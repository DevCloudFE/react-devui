          ...
          <article className="app-route-article">
            <h1 id="title">
              ...
              <DTooltip dTitle={t('Edit this page on GitHub')}>
                <DIcon className="app-icon-button" style={{ marginLeft: 4 }} viewBox="64 64 896 896" dSize={20}>
            ...
            <h2 id="Examples">
              ...
              <DTooltip dTitle={t('Expand all code')}>
                <DIcon className="app-icon-button" style={{ marginLeft: 4 }} viewBox="64 64 896 896" dSize={24}>
