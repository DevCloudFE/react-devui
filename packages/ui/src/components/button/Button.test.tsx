...
describe('DButton', () => {
  ...
  it('should `default dType` work', () => {
    const defaultDType = 'primary';
    render(<DButton />);
    expect(buttonClassList().contains(`${PREFIX}button--${defaultDType}`)).toBeTruthy();
  });

  it('should `default dColor` work', () => {
    const defaultDType = 'primary';
    render(<DButton />);
    expect(buttonClassList().contains(`t-${defaultDType}`)).toBeTruthy();
  });
...
describe('ButtonGroup', () => {
  ...
  it('should `buttonGroupDisabled` work', () => {
    const { getAllByRole } = render(
