...
export default function Demo() {
  ...
  return (
    <>
      ...
      />
      <br />
      <DSelect dOptions={options} placeholder="Basic" dSize={size} />
      <DSelect dOptions={options} placeholder="Multiple" dModel={[select, setSelect]} dMultiple dSearchable dClearable dSize={size} />
    </>
  );
}
```
