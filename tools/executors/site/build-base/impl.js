...
var GenerateSite = /** @class */ (function () {
    function GenerateSite() {
        ...
        Object.defineProperty(this, "appTmp", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        value: function (file, outDir) {
            ...
            if (menuGroupIndex === -1) {
                ...
                this.routeConfig.set(meta.title['en-US'], {
                    import: String.raw(templateObject_11 || (templateObject_11 = (0, tslib_1.__makeTemplateObject)(["./routes/components/", "/", ""], ["./routes/components/", "/", ""])), file.name, meta.title['en-US']),
        ...
        value: function () {
            ...
            try {
                for (var _b = (0, tslib_1.__values)(this.routeConfig.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
                    ...
                    importStr += String.raw(templateObject_19 || (templateObject_19 = (0, tslib_1.__makeTemplateObject)(["const ", " = lazy(() => import('", "'));\n"], ["const ", " = lazy(() => import('", "'));\n"])), key, value.import);
    ...
    Object.defineProperty(GenerateSite.prototype, "updateTmp", {
        ...
        value: function () {
            ...
            this.appTmp = (0, fs_extra_1.readFileSync)(path_1.default.join(__dirname, 'site', 'App.txt')).toString();
            this.routeTmp = (0, fs_extra_1.readFileSync)(path_1.default.join(__dirname, 'site', 'component-route.txt')).toString();
            this.menuConfig = [];
