...
var COMPONENT_DIR = String.raw(
  templateObject_1 || (templateObject_1 = (0, tslib_1.__makeTemplateObject)(['packages/ui/src/components'], ['packages/ui/src/components']))
);
var OUTPUT_DIR = String.raw(
  templateObject_2 || (templateObject_2 = (0, tslib_1.__makeTemplateObject)(['packages/site/src/app'], ['packages/site/src/app']))
);
var GenerateSite = /** @class */ (function () {
  ...
  Object.defineProperty(GenerateSite.prototype, 'generateComponentDemo', {
    ...
    value: function (file, outDir) {
      ...
      var fileNameRegExp = new RegExp(
        String.raw(
          templateObject_3 ||
            (templateObject_3 = (0, tslib_1.__makeTemplateObject)(['(?<=^[0-9]+.)[a-zA-Z]+(?=.md$)'], ['(?<=^[0-9]+.)[a-zA-Z]+(?=.md$)']))
        ),
        'g'
      );
      ...
      if (fileName && tsx) {
        ...
        if (scss) {
          outTSX =
            String.raw(
              templateObject_4 ||
                (templateObject_4 = (0, tslib_1.__makeTemplateObject)(["import './", ".scss';\n"], ["import './", ".scss';\n"])),
              fileName
            ) + outTSX;
          this.outputFile(
            path_1.default.join(outDir, ''.concat(fileName, '.scss')),
            String.raw(
              templateObject_5 ||
                (templateObject_5 = (0, tslib_1.__makeTemplateObject)(['\n#', '{\n  ', '\n}\n'], ['\n#', '{\n  ', '\n}\n'])),
              id,
              scss.split(/\n/g).join('\n  ')
            )
          );
        ...
        outTSX =
          String.raw(
            templateObject_6 ||
              (templateObject_6 = (0, tslib_1.__makeTemplateObject)(
                ['/* eslint-disable */\n// @ts-nocheck\n'],
                ['/* eslint-disable */\n// @ts-nocheck\n']
              ))
          ) + outTSX;
        ...
        Array.from(demo_1.keys()).forEach(function (lang, index, langs) {
          ...
          var descriptionRegExp = new RegExp(
            String.raw(
              templateObject_7 ||
                (templateObject_7 = (0, tslib_1.__makeTemplateObject)(['(?<=# ', ')[sS]*', ''], ['(?<=# ', ')[\\s\\S]*', ''])),
              lang,
              index === langs.length - 1 ? '(?=```tsx)' : '(?=# '.concat(langs[index + 1], ')')
            ),
            'g'
          );
          ...
          obj.importStatement = String.raw(
            templateObject_8 ||
              (templateObject_8 = (0, tslib_1.__makeTemplateObject)(
  ...
  Object.defineProperty(GenerateSite.prototype, 'generateComponentRoute', {
    ...
    value: function (file, outDir) {
      ...
      var menuGroupIndex = this.menuConfig.findIndex(function (menuGroup) {
        return menuGroup.title === enMeta.group;
      });
      if (menuGroupIndex === -1) {
        console.error(''.concat(enMeta.group, ' dont exist'));
      } else {
        var menuItemIndex = this.menuConfig[menuGroupIndex].children.findIndex(function (menuItem) {
          return menuItem.title === meta.title['en-US'];
        });
        if (menuItemIndex === -1) {
          this.menuConfig[menuGroupIndex].children.push({
            title: meta.title['en-US'],
            to: String.raw(
              templateObject_9 || (templateObject_9 = (0, tslib_1.__makeTemplateObject)(['/components/', ''], ['/components/', ''])),
              meta.title['en-US']
            ),
          });
        } else {
          this.menuConfig[menuGroupIndex].children[menuItemIndex] = {
            title: meta.title['en-US'],
            to: String.raw(
              templateObject_10 || (templateObject_10 = (0, tslib_1.__makeTemplateObject)(['/components/', ''], ['/components/', ''])),
              meta.title['en-US']
            ),
          };
        }
        this.routeConfig.set(meta.title['en-US'], {
          import: String.raw(
            templateObject_11 ||
              (templateObject_11 = (0, tslib_1.__makeTemplateObject)(['./components/', '/', ''], ['./components/', '/', ''])),
            file.name,
            meta.title['en-US']
          ),
          path: String.raw(
            templateObject_12 || (templateObject_12 = (0, tslib_1.__makeTemplateObject)(['/components/', ''], ['/components/', ''])),
            meta.title['en-US']
          ),
        });
        var importStr = '';
        ...
        try {
          for (
            var _c = (0, tslib_1.__values)((0, fs_extra_1.readdirSync)(path_1.default.join(file.path, 'demos'))), _d = _c.next();
            !_d.done;
            _d = _c.next()
          ) {
        ...
        ['en-US', 'zh-Hant'].forEach(function (lang) {
          ...
          demoList_1.forEach(function (demo) {
            if (demo) {
              var demoStr = String.raw(
                templateObject_13 ||
                  (templateObject_13 = (0, tslib_1.__makeTemplateObject)(
                    [
              ...
              demoStr = demoStr.replace(
                ...
                demo.get(lang).scss
                  ? String.raw(
                      templateObject_14 ||
                        (templateObject_14 = (0, tslib_1.__makeTemplateObject)(
                          ['scss={String.raw', '', '', '}'],
                          ['scss={String.raw', '', '', '}']
                        )),
                      '`',
                      (0, marked_1.default)(demo.get(lang).scss),
                      '`'
                    )
                  : ''
              );
                  ...
                  ? String.raw(
                      templateObject_15 ||
                        (templateObject_15 = (0, tslib_1.__makeTemplateObject)(
                          ['scssSource={String.raw', '', '', '}'],
                          ['scssSource={String.raw', '', '', '}']
                        )),
                      '`',
                      demo.get(lang).scss.match(/(?<=```scss\n)[\s\S]*?(?=```)/g)[0],
                      '`'
                    )
                  : ''
              );
              ...
              linksStr += String.raw(
                templateObject_16 ||
                  (templateObject_16 = (0, tslib_1.__makeTemplateObject)(
                    ["{ href: '#", "', title: '", "' }, "],
                    ["{ href: '#", "', title: '", "' }, "]
                  )),
                demo.get(lang).id,
          ...
          var routeArticleProps = String.raw(
            templateObject_17 ||
              (templateObject_17 = (0, tslib_1.__makeTemplateObject)(
                [
          ...
          if (description && api) {
            routeArticleProps = routeArticleProps.replace(
              /__description__/g,
              new TextEncoder().encode((0, marked_1.default)(description)).join()
            );
            routeArticleProps = routeArticleProps.replace(/__api__/g, new TextEncoder().encode((0, marked_1.default)(api)).join());
          }
          var langRegExp = new RegExp(
            String.raw(templateObject_18 || (templateObject_18 = (0, tslib_1.__makeTemplateObject)(['__', '__'], ['__', '__'])), lang),
            'g'
          );
  ...
  Object.defineProperty(GenerateSite.prototype, 'generateGlobalFiles', {
    ...
    value: function () {
      ...
      this.outputJson(path_1.default.join(OUTPUT_DIR, 'configs', 'resources.json'), this.resources);
      var importStr = '';
      var routeStr = '';
      try {
        for (var _b = (0, tslib_1.__values)(this.routeConfig.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
          var _d = (0, tslib_1.__read)(_c.value, 2),
            key = _d[0],
            value = _d[1];
          importStr += String.raw(
            templateObject_19 ||
              (templateObject_19 = (0, tslib_1.__makeTemplateObject)(
                ['const ', " = lazy(() => import('", "'));\n"],
                ['const ', " = lazy(() => import('", "'));\n"]
              )),
            key,
      ...
      this.outputFile(path_1.default.join(OUTPUT_DIR, 'routes', 'Routes.tsx'), routesTmp);
    },
  });
  Object.defineProperty(GenerateSite.prototype, 'generateAll', {
    ...
    value: function () {
      ...
      try {
        for (
          var components_1 = (0, tslib_1.__values)(components), components_1_1 = components_1.next();
          !components_1_1.done;
          ...
          if (
            ...
            (0, fs_extra_1.statSync)(componentPath).isDirectory() &&
            (0, fs_extra_1.readdirSync)(componentPath).includes('README.md')
          ) {
            this.generateComponentRoute(
              { name: component, path: componentPath, data: components },
              path_1.default.join(OUTPUT_DIR, 'routes', 'components', component)
            );
          }
        }
      } catch (e_3_1) {
  ...
  Object.defineProperty(FileWatcher.prototype, 'onUpdate', {
    get: function () {
      ...
      return this.subject.pipe(
        (0, operators_1.debounceTime)(200),
  ...
  Object.defineProperty(FileWatcher.prototype, 'addWatcher', {
    ...
    value: function (file, task) {
      ...
      this.watcherList.set(
        file,
        (0, fs_extra_1.watch)(file, function () {
      ...
      switch (_a.label) {
        case 0:
          ...
          refreshComponentWatcher_1 = function () {
            ...
            try {
              for (
                var components_2 = (0, tslib_1.__values)(components), components_2_1 = components_2.next();
                !components_2_1.done;
                components_2_1 = components_2.next()
              ) {
          ...
          return [
            5 /*yield**/,
            (0, tslib_1.__values)(
              (0, tslib_1.__asyncDelegator)(
                (0, tslib_1.__asyncValues)(
                  (0, rxjs_for_await_1.eachValueFrom)(fileWatcher_1.onUpdate.pipe((0, operators_1.mapTo)({ success: true })))
                )
              )
            ),
          ];
        case 1:
          return [4 /*yield*/, tslib_1.__await.apply(void 0, [_a.sent()])];
        case 2:
          return [4 /*yield*/, tslib_1.__await.apply(void 0, [_a.sent()])];
        case 3:
          return [2 /*return*/, _a.sent()];
        case 4:
          return [4 /*yield*/, (0, tslib_1.__await)({ success: true })];
        case 5:
          return [2 /*return*/, _a.sent()];
      }
    });
